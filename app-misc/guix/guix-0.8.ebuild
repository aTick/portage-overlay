...
DESCRIPTION="guix: The purely functional package manager of the GNU system."
...
# Portage.
SRC_URI="ftp://alpha.gnu.org/gnu/guix/guix-0.8.tar.gz"
...
dev-libs/libgcrypt
https? ( net-libs/gnutls[guile] )
daemon? ( dev-db/sqlite 
          app-arch/bzip2
          sys-devel/gcc[cxx] )
"
